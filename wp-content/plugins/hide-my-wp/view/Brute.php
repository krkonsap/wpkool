                    ...
                    <div class="card-body">
                        ...
                        <div class="hmw_brute_enabled" <?php echo(!HMW_Classes_Tools::getOption('hmw_bruteforce') ? 'style="display:none"' : '') ?> >
                            ...
                            <div class="group_autoload col-sm-12 d-flex justify-content-center btn-group mt-3" role="group" data-toggle="button">
                                ...
                                <div class="hmw_pro mt-1" style="position: relative" data-toggle="popover" data-html="true" data-placement="top" data-content="<?php echo sprintf(__('This feature requires %sHide My WP Ghost%s.', _HMW_PLUGIN_NAME_), "<a href='http://hidemywp.co/' target='_blank'>", "</a>") ?>">

    ...
    public function checkCompatibility() {
        ...
        if (!is_admin()) {
            ...
            if (HMW_Classes_Tools::isPluginActive('wp-rocket/wp-rocket.php')) {
                ...
                add_filter('rocket_cache_busting_filename', array($this, 'rocket_find_replace_wp'), PHP_INT_MAX);
                add_filter('rocket_iframe_lazyload_placeholder', array($this, 'rocket_find_replace_wp'), PHP_INT_MAX);

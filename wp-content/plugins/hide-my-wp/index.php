...
/*
  ...
  Plugin URI:
  Description: You can change and hide WordPress common paths and URLs to increases your WP Security against hacker's bots. <br /> <a href="http://hidemywp.co/wordpress" target="_blank"><strong>Unlock all features</strong></a>
  Version: 3.0.00
  Author: WPPlugins - WordPress Security Plugins
  Author URI: https://wpplugins.tips
 */
if (!defined('HMW_VERSION')) {
    define('HMW_VERSION', '3.0.00');
    /* Call config files */

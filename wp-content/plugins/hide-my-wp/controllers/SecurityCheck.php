                ...
                if (!in_array($function, $tasks_ignored)) {
                    if (isset($tasks[$function])) {
                        ...
                        if (!HMW_Classes_Tools::getOption('hmw_token')) {
                            ...
                            if (isset($row['javascript']) && $row['javascript'] <> '') {
                                $row['pro'] = '<div class="btn btn-warning text-white" data-toggle="popover" data-html="true" data-placement="top" data-content="' . sprintf(__('This feature requires %sHide My WP Ghost%s.', _HMW_PLUGIN_NAME_), "<a href='http://hidemywp.co/' target='_blank'>", "</a>") . '">' . __('PRO', _HMW_PLUGIN_NAME_) . '</div>';
                            }
    ...
    public function getTasks() {
        return array(
            ...
            'checkSSL' => array(
                ...
                'solution' => sprintf(__("Learn how to set your website as %s. %sClick Here%s", _HMW_PLUGIN_NAME_), '<strong>' . str_replace('http:', 'https:', site_url()) . '</strong>', '<a href="https://www.wpbeginner.com/wp-tutorials/how-to-add-ssl-and-https-in-wordpress/" target="_blank">', '</a>'),
            ),
...
//            ),
            ...
            'checkOldPaths' => array(
                ...
                'solution' => sprintf(__("Switch on %sHide My Wp > Hide WordPress Common Paths%s", _HMW_PLUGIN_NAME_), '<strong>', '</strong>'),
            ...
            'checkConfig' => array(
                ...
                'warning' => false,
                'message' => __("One of the most important files in your WordPress installation is the wp-config.php file. <br />This file is located in the root directory of your WordPress installation and contains your website's base configuration details, such as database connection information.", _HMW_PLUGIN_NAME_),
                'solution' => sprintf(__("Switch on %sHide My Wp > Hide WordPress Common Files%s", _HMW_PLUGIN_NAME_), '<strong>', '</strong>'),
            ...
            'checkInstall' => array(
                ...
                'solution' => sprintf(__("Rename wp-admin/install.php & wp-admin/upgrade.php files or switch on %sHide My Wp > Hide WordPress Common Paths%s", _HMW_PLUGIN_NAME_), '<strong>', '</strong>'),
                'javascript' => "jQuery(this).hmw_fixSettings('hmw_hide_oldpaths',1);",
            ),
            ...
            'checkMysqlPermissions' => array(
                ...
                'solution' => sprintf(__("To learn how to revoke permissions from PhpMyAdmin %sClick here%s", _HMW_PLUGIN_NAME_), '<a href="http://hidemywp.co/article/how-to-grant-and-revoke-permissions-to-database-using-phpmyadmin/" target="_blank">', '</a>'),
            ),
            'checkUsersById' => array(
                ...
                'solution' => sprintf(__("Switch on %sHide My Wp > Tweaks > Hide Author ID URL%s", _HMW_PLUGIN_NAME_), '<strong>', '</strong>'),
    ...
    public function checkPluginsUpdates() {
        ...
        return array(
            'value' => ($plugin_update_cnt > 0 ? sprintf(__('%s plugin are outdated: %s', _HMW_PLUGIN_NAME_), $plugin_update_cnt, join(',',$plugins)) : __('All plugins are up to date', _HMW_PLUGIN_NAME_)),
    ...
    public function checkVersionDisplayed() {
        return array(
            'value' => (HMW_Classes_Tools::getOption('hmw_hide_version') ? 'Removed' : 'Visible'),
            'valid' => (HMW_Classes_Tools::getOption('hmw_hide_version')),
        );
    }
